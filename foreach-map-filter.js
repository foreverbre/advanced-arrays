...
some key and returns a new array with the value of that key in each 
object.
...
Examples:
    ...
    last:"Steele"}]) 
    // ['Elie Schoppik', 'Tim Garcia', 'Matt Lane', 
    'Colt Steele']
*/
...
Examples:
    ...
    last:"Garcia", isCatOwner: true}, {first: 'Matt', last:"Lane"}, 
    {first: 'Colt', last:"Steele", isCatOwner: true}], 'isCatOwner') 
    
    // [{first: 'Tim', last:"Garcia", isCatOwner: true}, {first: 'Colt', 
...
/*
Write a function called findInObj which accepts an array of objects, a 
key, and some value to search for and returns the first found value in 
the array.
...
new string with all of the vowels (both uppercased and lowercased) 
